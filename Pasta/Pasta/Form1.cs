...
namespace Pasta
{
    public partial class Form1 : Form
    {
        ...
        List<DataTable> tablolar = new List<DataTable>();
        List<Filtre> filtreler = new List<Filtre>();
        ...
        private List<Veriler> GrafikVerisiOlustur(DataTable tablo, int hangiSutun)
        {
                ...
                else
                {
                    ...
                    foreach (string ss in s)
                    {
                        ...
                        else
                        {
                            if (ss.ToString() != "")
                            {
                                Veriler v = new Veriler(1, ss.Trim().ToLower());
                                verilerList.Add(v);
                            }
                        }
                    }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                dataGridView1.DataSource = tablolar.FirstOrDefault();
                dataGridView2.DataSource = tablolar.FirstOrDefault();
